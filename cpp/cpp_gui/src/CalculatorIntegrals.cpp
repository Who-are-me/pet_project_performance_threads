...
CalculatorIntegrals::CalculatorIntegrals (f64 start, f64 end, u64 count_steps, const std::function<f64 (f64, f64)> integral_function) {
...
void CalculatorIntegrals::calculator (f64 start, f64 end, u64 count_steps_on_thread, const std::function<f64 (f64, f64)> integral_function) {
...
void CalculatorIntegrals::setCountThreads (u16 count) {
